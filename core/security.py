...
from .exceptions import SecurityViolation, AuthenticationError
...
class Authentication:
    ...
    def _init_users_db(self):
        ...
        if cursor.fetchone()[0] == 0:
            ...
            cursor.execute(
                ...
                ('admin', default_password, 'System Administrator', 'cyberzilla.systems@gmail.com', 'admin')
            )
    ...
    def verify_password(self, plain_password: str, hashed_password: str) -> bool:
        ...
        return hmac.compare_digest(
            self._hash_password(plain_password),
            hashed_password
        )
    ...
    def _create_access_token(self, username: str) -> str:
        ...
        expires_delta = timedelta(minutes=self.settings.security.ACCESS_TOKEN_EXPIRE_MINUTES)
...
class SecurityManager:
    ...
    def log_operation(self, username: str, operation: str, details: str):
        ...
        timestamp = datetime.now().isoformat()
        log_entry = f"{timestamp} | USER:{username} | OP:{operation} | DETAILS:{details}\n"
