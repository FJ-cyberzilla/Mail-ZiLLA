...
class ProxyManager:
    ...
    async def auto_acquire_proxies(self) -> List[str]:
        ...
        console.print(f"[green]✅ Acquired {len(unique_proxies)} potential proxies[/green]")
    ...
    async def health_check_proxies(self, proxies: List[str]) -> List[str]:
        ...
        console.print(f"[green]✅ {len(healthy_proxies)}/{len(proxies)} proxies passed health check[/green]")
        return healthy_proxies
