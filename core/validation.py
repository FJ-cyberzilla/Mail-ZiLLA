...
class EmailValidator:
    ...
    def __init__(self):
        ...
        self.common_providers = ['gmail.com', 'yahoo.com', 'outlook.com', 'hotmail.com', 'protonmail.com']
    ...
    async def validate_email_comprehensive(self, email: str) -> Dict[str, Any]:
        ...
        try:
            ...
            is_valid = (
                ...
                domain_result['is_valid'] and
                smtp_result['is_reachable'] and
                not disposable_result['is_disposable']
            )
            ...
            for mx_host in mx_hosts[:2]:  # Limit to first 2 hosts
                try:
                    ...
                    if code == 250:
                        ...
                        result['details']['smtp_response'] = f"{code}: {message.decode()}"
    ...
    def _load_disposable_domains(self) -> set:
        ...
        return {
            ...
            'trashmail.com', 'disposablemail.com', 'yopmail.com'
        }
