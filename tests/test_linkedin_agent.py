...
try:
    ...
    from core.base_agent import ProfileData, Platform
except ImportError:
    ...
    class ProfileData:
        def __init__(self, platform, profile_url, username, full_name, email, phone, 
                     location, bio, avatar_url, last_activity, confidence_score, raw_data):
